...
| **禮拜二** | `機器學習、AI資訊安全` | `2.機器學習、AI資訊安全` | 經典機器學習、統計學習、AI 資安、入侵偵測、惡意程式防禦 |
...
> 🎯 **嚴格對題過濾**：每個主題都定義「對題關鍵字」（config.py 的 `keywords`）。論文（學術資料庫來源）與 GitHub 專案會先依關鍵字嚴格過濾，不符合當日主題的結果一律剔除，確保新聞、論文、專案三者皆與當日主題相符。
